...
|
*/
$config['base_url'] = 'http://localhost/plab/www/';
...
|
*/
$config['log_path'] = APPPATH . '../../tmp/log/';
...
|
*/
$config['cache_path'] = APPPATH . '../../tmp/cache/';
...
|
*/
$config['encryption_key'] = hex2bin('47debb3b25b5b2a7138212a5a8b005e7'); // AES-128 / Rijndael-128; Generated by /CommunityAuth/Key_Creator on 20190102
...
$config['sess_cookie_name'] = 'plabSessCookie';
$config['sess_expiration'] = 7200;
//$config['sess_save_path'] = NULL;
$config['sess_save_path'] = 'plab_session';
$config['sess_match_ip'] = false;
$config['sess_time_to_update'] = 300;
//$config['sess_time_to_update'] = $config['sess_expiration']; // Fix for session data lost during frequent AJAX call
...
$config['csrf_token_name'] = 'plabCSRFToken';
$config['csrf_cookie_name'] = 'plabCookie';
...
//$config['modules_locations'][] = APPPATH . 'modules/'; // Core modules
$config['modules_locations'][] = APPPATH . '../../app/'; // Application modules
